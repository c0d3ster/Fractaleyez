    ...
    return(
      <Row>
        <Col className='presets-container'>
          ...
          <button onClick={this.props.retrieveConfigPreset}>ATYYA Woods</button>
          <button onClick={this.props.retrieveConfigPreset}>ATYYA DNA</button>
          ...
          <button onClick={this.props.retrieveConfigPreset}>ATYYA Plume</button>
          <button onClick={this.props.retrieveConfigPreset}>ATYYA Water</button>
          ...
          <button onClick={this.props.retrieveConfigPreset}>ATYYA Finnoh Salad</button>
          <button onClick={this.props.retrieveConfigPreset}>Sharlitz Portal</button>
          <button onClick={this.props.retrieveConfigPreset}>Sharlitz Cave</button>
          <button onClick={this.props.retrieveConfigPreset}>Sharlitz Spin</button>
          <button onClick={this.props.retrieveConfigPreset}>Sharlitz Spider Spin</button>
          <button onClick={this.props.retrieveConfigPreset}>Sharlitz Web Red</button>
